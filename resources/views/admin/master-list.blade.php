            ...
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                              <div class="float-left">
                                  <strong class="card-title">Master List</strong>
                              </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <!-- TABEL MASTER -->
                                        <tr>
                                          <th>{{$m->id_info_user}}</th>
                                          <th>{{$m->email}}</th>
                                          <th>{{$m->nama_depan}}</th>
                                          <th>{{$m->nama_belakang}}</th>
                                          <th>{{$m->gender}}</th>
                                          <th>{{$m->domisili}}</th>
                                          <th>{{$m->nomor_telp}}</th>
                                          <th>{{$m->skill}}</th>
                                          <th>{{$m->introduction}}</th>
                                          <th>
                                              <center>

                                                <a href="{{url('update_masterview', $m->id_info_user)}}" class="btn btn-outline-primary btn-sm" role="button"><span class="ti-pencil-alt"></span></a>
                                                <a href="{{url('deletemasteradmin', $m->id_info_user)}}" class="btn btn-outline-danger btn-sm" role="button"><span class="ti-trash"></span></a>
                                              </center>
                                          </th>
                                        </tr>
                                        @endforeach
                    ...
                    <div id="id01" class="modal">
                        ...
                        @endif
                    <form class="modal-content animate" method="post" action="regis">
                        @csrf
                      ...
                      <div class="container">
                        ...
                        <input type="text" placeholder="Enter Password" name="repassword" required>
                        <br>
                        <div class="float-right">
