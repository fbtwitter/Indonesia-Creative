            ...
            <div class="animated fadeIn">
                <div class="row">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <th>{{$mem->gender}}</th>
                                          <th>{{$mem->domisili}}</th>
                                          <th>{{$mem->nomor_telp}}</th>
                                            <th>{{$mem->skill}}</th>
                                            <th>{{$mem->introduction}}</th>

                                          <th>
                                              <center>

                                                <a href="{{url('deletemember', $mem->id_info_user)}}" class="btn btn-outline-danger btn-sm" role="button"><span class="ti-trash"></span></a>
                                              </center>
                                          </th>
                                        </tr>
                                        @endforeach
                   ...
                   <!-- <div id="id01" class="modal">
                    <form class="modal-content animate" action="member-list.php">
                      ...
                      <div class="container">
                        ...
                        <div class="float-right">
                          ...
                          <button type="submit" class="btn btn-outline-primary btn-sm">Add a New Member</button>
                        </div>
                      </div>
