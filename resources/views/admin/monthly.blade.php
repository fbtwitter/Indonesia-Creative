...
<head>
    ...
    <title>Indonesia Creative - Monthly Member</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col">Peserta Monthly Meeting</th>
                                        <th scope="col">Feedback</th>
                                        <th scope="col">Monthly Meeting</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      <th>{{$bulan['ID_PESERTAMONTHLY']}}</th>
                                      <th>{{$bulan['ID_FEEDBACK']}}</th>
                                      <th>{{$bulan['ID_MONTHLYMEETING']}}</th>
                                      <th>{{$bulan['ID_REWARD']}}</th>
                                      <th></th>
                                      <th>
                                          <center>
                                            <a href="{{url('deletemonth', $bulan['ID_PESERTAMONTHLY'])}}" class="btn btn-outline-danger btn-sm" role="button"><span class="ti-trash"></span></a>
