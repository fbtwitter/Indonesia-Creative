...
<head>
    ...
    <title>Indonesia Creative - Reward</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                              <div class="float-left">
                                  <strong class="card-title">Reward</strong>
                              </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          <th>{{$r['ID_REWARD']}}</th>
                                          <th>{{$r['ID_PESERTAMONTHLY']}}</th>
                                          <th>{{$r['ID_DAFTAR_MASTER']}}</th>
                                          <th>{{$r['NILAI']}}</th>
                                          <th>
                                              <center>
                                                <!--<a href="#" class="btn btn-outline-primary btn-sm" role="button"><span class="ti-pencil-alt"></span></a>-->
                                                <a href="{{url('deleterewardadmin', $r['ID_REWARD'])}}" class="btn btn-outline-danger btn-sm" role="button"><span class="ti-trash"></span></a>
                                              </center>
                                          </th>
                                        </tr>
                                        @endforeach
