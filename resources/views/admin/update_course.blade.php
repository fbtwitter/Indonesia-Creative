                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="member-list.php">Course List</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                              <form action="{{ url('course_update', $courses['ID_COURSE']) }}" class="form-horizontal" method="post">
                                 @csrf
                        				  <div class="form-group">
                            					<label class="col-md-2 control-label">ID Course</label>
                            					<div class="col-md-10">
                            					  <input name="ID_COURSE" type="text" id="ID_COURSE" class="form-control" value="{{$courses->ID_COURSE}}" disabled>
                            					</div>
                        				  </div>
                        				  <div class="form-group">
                                    <label class="col-md-2 control-label">Course Name</label>
                                    <div class="col-md-10">
                                      <input name="NAMA_COURSE" type="text" id="NAMA_COURSE"  class="form-control" value="{{$courses->NAMA_COURSE}}">
                                    </div>
                        				  </div>
                        				  <div class="form-group">
                                    <label class="col-md-2 control-label">Definition</label>
                                    <div class="col-md-10">
                                      <input name="DEFINISI_COURSE" type="text" id="DEFINISI_COURSE"  class="form-control" value="{{$courses->DEFINISI_COURSE}}">
                                    </div>
                        				  </div>
