            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        ...
                        <strong class="card-title">Monthly Meeting</strong>
                        </div>
                        <div class="float-right">
                        <button onclick="document.getElementById('id07').style.display='block'" style="width:auto;" class="btn btn-outline-dark">Add an Agenda</i></button>
                        </div>
                        </div>
                        <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <!-- TABEL Monthly Meeting -->
                            <tr>
                                <th>{{ $data->DATE}}</th>
                                <th>{{ $data->PLACE}}</th>
                                <th>{{ $data->DEFINISI_MNTHLY}}</th>
                                <th>
                                <div class="float-right">
                                @csrf
                                <center>
                                    <a href="{{ url('MonthlyMember', $data->ID_MONTHLYMEETING)}}" class="btn btn-outline-primary btn-sm" role="button">Detail</a>
                                    <a href="{{route('Monthly.edit', $data->ID_MONTHLYMEETING)}}" class="btn btn-outline-primary btn-sm" role="button"><span class="ti-pencil-alt"></span></a>
                                    {{ method_field('DELETE')}}
                                    <a href="{{url('MonthlyDelete',  $data->ID_MONTHLYMEETING)}}" class="btn btn-outline-danger btn-sm" role="button" ><span class="ti-trash"></span>
                                    </a>
                                </center>
                                </div>
                                </th>
                    ...
                    <form class="modal-content animate" action="{{ route('Monthly.store')}}" method="post">
                    @csrf
                        <div class="card-header">
                        <div class="float-left">
                            <strong class="card-title">Create an Agenda</strong>
                        </div>
                        <div class="float-right">
                        ...
                        <div class="container">
                        <label for="idmonthly"><b>ID</b></label>
                        <input type="text" placeholder="Enter ID Monthly Meeting" name="idmonthly" required>
                        ...
                        <input type="text" placeholder="Enter Definition of Monthly" name="definisiagenda" required>
                        <br></br>
                        <div class="float-right">
                            <button type="button" onclick="document.getElementById('id07').style.display='none'" class="btn btn-outline-danger btn-sm">Cancel</button>
