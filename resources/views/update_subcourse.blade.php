                              ...
                              <form action="{{ url('subcourse_update', $subs['ID_SUB_COURSE']) }}" class="form-horizontal" method="post">
                                  @csrf
                        				  <div class="form-group">
                            					...
                            					<div class="col-md-10">
                            					  <input name="ID_SUB_COURSE" type="text" id="ID_SUB_COURSE" class="form-control" value="{{$subs->ID_SUB_COURSE}}">
                            					</div>
                        				  </div>
                        				  <div class="form-group">
                                    <label class="col-md-2 control-label">ID Course</label>
                                    <div class="col-md-10">
                                      <input name="ID_COURSE" type="text" id="ID_COURSE"  class="form-control" value="{{$subs->ID_COURSE}}">
                                    </div>
                        				  </div>
                        				  <div class="form-group">
                                    <label class="col-md-2 control-label">ID Master</label>
                                    <div class="col-md-10">
                                      <input name="ID_DAFTAR_MASTER" type="text" id="ID_DAFTAR_MASTER"  class="form-control" value="{{$subs->ID_DAFTAR_MASTER}}">
                                    </div>
                        				  </div>
                        				  <div class="form-group">
