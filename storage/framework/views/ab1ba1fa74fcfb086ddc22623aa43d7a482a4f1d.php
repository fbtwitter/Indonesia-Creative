...
<section class="portfolio-carousel wow fadeIn">
            ...
            <div class="row">
                <div class="col-md-4 col-md-push-8">
                    <div class="project-details">
                        <img src="<?php echo e(asset('front/assets/img/client-logos/logo-1.png')); ?>" class="img-responsive client-logo" alt="">
                ...
                <div class="col-md-8 col-md-pull-4 hidden-xs">
                    <img src="<?php echo e(asset('front/assets/img/portfolio/mobile-screens.png')); ?>" class="img-responsive portfolio-image" alt="">
                </div>
            </div>
        </div>
    </div>
    <div class="item" style="background-image: url('<?php echo e(asset('front/assets/img/creative/portfolio/bg-2.jpg')); ?>')">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-md-push-8">
                    <div class="project-details">
                        <img src="<?php echo e(asset('front/assets/img/client-logos/logo-2.png')); ?>" class="img-responsive client-logo" alt="">
                        <span class="project-name">Project Name</span>
                        <span class="project-description">Branding, Website Design</span>
                        <hr class="colored">
                ...
                <div class="col-md-8 col-md-pull-4 hidden-xs">
                    <img src="<?php echo e(asset('front/assets/img/portfolio/tablet-screens.png')); ?>" class="img-responsive portfolio-image" alt="">
                </div>
            </div>
        </div>
    </div>
    <div class="item" style="background-image: url('<?php echo e(asset('front/assets/img/creative/portfolio/bg-3.jpg')); ?>')">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-md-push-8">
                    <div class="project-details">
                        <img src="<?php echo e(asset('front/assets/img/client-logos/logo-3.png')); ?>" class="img-responsive client-logo" alt="">
                        <span class="project-name">Project Name</span>
                        <span class="project-description">Branding, Website Design</span>
                        <hr class="colored">
    ...
    <div class="item" style="background-image: url('<?php echo e(asset('front/assets/img/creative/portfolio/bg-4.jpg')); ?>')">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-md-push-8">
                    <div class="project-details">
                        <img src="<?php echo e(asset('front/assets/img/client-logos/logo-4.png')); ?>" class="img-responsive client-logo" alt="">
                        <span class="project-name">Project Name</span>
                        <span class="project-description">Branding, Website Design</span>
                        <hr class="colored">
        ...
        <div class="row content-row">
            <div class="col-lg-12">
                <div class="about-carousel">
                    <div class="item">
                        <img src="<?php echo e(asset('front/assets/img/culinary/people/1.jpg')); ?>" class="img-responsive" alt="">
                        <div class="caption">
                    ...
                    <div class="item">
                        <img src="<?php echo e(asset('front/assets/img/culinary/people/2.jpg')); ?>" class="img-responsive" alt="">
                        <div class="caption">
                    ...
                    <div class="item">
                        <img src="<?php echo e(asset('front/assets/img/culinary/people/3.jpg')); ?>" class="img-responsive" alt="">
                        <div class="caption">
                    ...
                    <div class="item">
                        <img src="<?php echo e(asset('front/assets/img/culinary/people/4.jpg')); ?>" class="img-responsive" alt="">
                        <div class="caption">
                            <h3>Steven Cooper</h3>
                            <hr class="colored">
                            <p><em>Executive Chef</em>
                    ...
                    <div class="item">
                        <img src="<?php echo e(asset('front/assets/img/culinary/people/5.jpg')); ?>" class="img-responsive" alt="">
                        <div class="caption">
                    ...
                    <div class="item">
                        <img src="<?php echo e(asset('front/assets/img/culinary/people/6.jpg')); ?>" class="img-responsive" alt="">
                        <div class="caption">
                            <h3>Thomas Cheung</h3>
                            <hr class="colored">
                            <p><em>Corkmaster</em>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="testimonial-info">
                                    <div class="testimonial-img">
                                        <img src="<?php echo e(asset('front/assets/img/testimonials/1.jpg')); ?>" class="img-circle img-responsive" alt="">
                                    </div>
